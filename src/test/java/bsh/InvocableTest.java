...
public class InvocableTest {
  ...
  public void constructor_invocable() throws Exception {
    ...
    assertThat(t.getVarArgsType(), equalTo(Void.TYPE));
    assertThat(
        t.hashCode(), equalTo(Invocable.get(Tester.class.getDeclaredConstructors()[0]).hashCode()));
  ...
  public void method_invocable() throws Exception {
    Invocable t =
        Invocable.get(Tester.class.getDeclaredMethod("test", new Class[] {String[].class}));
